      ...
      <ContentWrapper>
            ...
            <Col lg={4}>
              ...
              <Card className="card-default">
                <CardHeader>Dismissable Card
                  <CardTool dismiss refresh onRemove={this.onCardRemove} onRemoved={this.onCardRemoved}
        ...
        <div>
          <div className="custom-control custom-checkbox mb-3">
            <input type="checkbox" id="customCheck1" className="custom-control-input" checked={this.state.oneAtATime}
          ...
          <Card className="card-default mb-1">
            ...
            <Collapse isOpen={this.state.accordionState[0]}>
              <CardBody className="border-top">Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus
                ...
                accusamus labore sustainable VHS.</CardBody>
            </Collapse>
          </Card>
          <Card className="card-default mb-1">
              ...
              <CardBody>
                <div role="tabpanel">
                  ...
                  <TabContent activeTab={this.state.activeTab}>
                    <TabPane tabId="1">Suspendisse velit erat, vulputate sit amet feugiat a, lobortis nec
                      felis.</TabPane>
